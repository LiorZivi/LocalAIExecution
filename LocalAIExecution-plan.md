...
## [ ] Phase 1: Platform scaffold & packaging skeleton
...
### [ ] Step 1.1: Create repo with core + capabilities source layout
...
### [ ] Step 1.2: Author pyproject with console-script entry point
...
### [ ] Step 1.4: Example layered configuration file
...
## [ ] Phase 2: GPU-aware bootstrap & CUDA stack
...
### [ ] Step 2.1: GPU detection & CUDA verification module + `doctor`
...
### [ ] Step 2.2: Bootstrap script with cu128 torch install
...
### [ ] Step 2.3: CUDA tensor smoke in bootstrap
...
## [ ] Phase 3: Core platform seams — adapter interface, registry, config, errors
...
### [ ] Step 3.1: Capability/adapter interface (the common contract)
...
### [ ] Step 3.2: Capability/model registry keyed by capability + model
...
### [ ] Step 3.3: Layered configuration with capability/model precedence
...
### [ ] Step 3.4: Typed errors & deterministic exit codes
...
## [ ] Phase 4: Core artifact/provenance, resident engine & CLI dispatch
...
### [ ] Step 4.1: Generic artifact, provenance & writer-selection seam
...
### [ ] Step 4.2: Core resident engine (load-once lifecycle)
...
### [ ] Step 4.3: Top-level CLI dispatcher (core + capability subcommands)
...
### [ ] Step 4.4: Shared `--json` result contract
...
## [ ] Phase 5: Text-to-image adapter (first capability) — FLUX one-shot
...
### [ ] Step 5.1: Register the text-to-image capability + FLUX model specs
...
### [ ] Step 5.2: Size presets & dimension validation (capability-local)
...
### [ ] Step 5.3: Image artifact writer (PNG + embedded params + sidecar)
...
### [ ] Step 5.4: Adapter `load_pipeline` + model-aware `run`
...
### [ ] Step 5.5: `generate` subcommand + bootstrap model-warm/smoke
...
## [ ] Phase 6: Interactive mode & runtime robustness
...
### [ ] Step 6.1: Interactive REPL scaffold (resident load-once)
...
### [ ] Step 6.2: In-loop overrides & control commands
...
### [ ] Step 6.3: Model switching & VRAM hygiene
...
### [ ] Step 6.4: Gated dev model access & token UX
...
### [ ] Step 6.5: OOM, offload, precision & performance options
...
## [ ] Phase 7: Docs, tests & end-to-end validation
...
### [ ] Step 7.1: Complete README & troubleshooting
...
### [ ] Step 7.2: Skill-invocation contract & adding-a-capability guide
...
### [ ] Step 7.3: Finalize unit test suite
...
### [ ] Step 7.4: End-to-end validation against success criteria
